...
public class DCA extends Unite {
	...
	private int joueur1;
	private Mitrailleuse_lourde arme;
	private int prix;

	public DCA(String unite, int n) {
		super();
		this.unite = unite;
		this.joueur1 = n;
		this.arme = new Mitrailleuse_lourde();
		this.prix = 6000;
	}
	...
	public void attaque(Unite unite) {
		if(unite.getString().equals("Bazooka")) {
			...
			if(unite.getPv() > 0.0) {
				...
				double riposte = unite.getArmes().get("DCA") * point_rip;
